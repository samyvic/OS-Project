  ...
  1f:	31 db                	xor    %ebx,%ebx
{
  ...
  47:	73 66 73 
  printf(1, "stressfs starting\n");
  4a:	e8 61 05 00 00       	call   5b0 <printf>
  memset(data, 'a', sizeof(data));
  ...
  5f:	83 c4 10             	add    $0x10,%esp
    if(fork() > 0)
  62:	e8 da 03 00 00       	call   441 <fork>
  ...
  printf(1, "write %d\n", i);
  85:	68 2b 09 00 00       	push   $0x92b
  8a:	6a 01                	push   $0x1
  8c:	e8 1f 05 00 00       	call   5b0 <printf>
  path[8] += i;
  ...
  a6:	50                   	push   %eax
  a7:	e8 dd 03 00 00       	call   489 <open>
...
//    printf(fd, "%d\n", i);
  ...
  c0:	56                   	push   %esi
  c1:	57                   	push   %edi
  c2:	e8 a2 03 00 00       	call   469 <write>
  for(i = 0; i < 20; i++)
  ...
  d2:	57                   	push   %edi
  d3:	e8 99 03 00 00       	call   471 <close>

  printf(1, "read\n");
  d8:	58                   	pop    %eax
  d9:	5a                   	pop    %edx
  da:	68 35 09 00 00       	push   $0x935
  df:	6a 01                	push   $0x1
  ...
  f5:	50                   	push   %eax
  f6:	e8 8e 03 00 00       	call   489 <open>
 ...
 108:	56                   	push   %esi
 109:	57                   	push   %edi
 10a:	e8 52 03 00 00       	call   461 <read>
  for (i = 0; i < 20; i++)
 ...
 11a:	57                   	push   %edi
 11b:	e8 51 03 00 00       	call   471 <close>

  wait();
 120:	e8 2c 03 00 00       	call   451 <wait>

  exit();
 125:	e8 1f 03 00 00       	call   449 <exit>
 ...
 269:	31 f6                	xor    %esi,%esi
{
 ...
 288:	50                   	push   %eax
 289:	6a 00                	push   $0x0
 28b:	e8 d1 01 00 00       	call   461 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 2f1:	e8 93 01 00 00       	call   489 <open>
  if(fd < 0)
 ...
 305:	50                   	push   %eax
 306:	e8 96 01 00 00       	call   4a1 <fstat>
  close(fd);
 30b:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 30e:	89 c6                	mov    %eax,%esi
  close(fd);
 310:	e8 5c 01 00 00       	call   471 <close>
  return r;
...
int thread_join()
{
 ...
 3dd:	50                   	push   %eax
 3de:	e8 0e 01 00 00       	call   4f1 <join>
...
void lock_release(struct lock_t *lk){
 ...
 439:	8b 55 08             	mov    0x8(%ebp),%edx
 43c:	f0 87 02             	lock xchg %eax,(%edx)
  xchg(&lk->locked,0) ;
}
 43f:	5d                   	pop    %ebp
 440:	c3                   	ret    
 ...
 50c:	89 d1                	mov    %edx,%ecx
{
 ...
 539:	0f b6 92 44 09 00 00 	movzbl 0x944(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 5f9:	e8 6b fe ff ff       	call   469 <write>
 ...
 659:	e8 0b fe ff ff       	call   469 <write>
        putc(fd, c);
      } else {
 ...
 66d:	e8 f7 fd ff ff       	call   469 <write>
  for(i = 0; fmt[i]; i++){
 ...
 6e1:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 6e4:	e8 80 fd ff ff       	call   469 <write>
        ap++;
 ...
 734:	eb 1a                	jmp    750 <printf+0x1a0>
          s = "(null)";
 736:	bb 3b 09 00 00       	mov    $0x93b,%ebx
        while(*s != 0){
 ...
 75b:	57                   	push   %edi
 75c:	53                   	push   %ebx
 75d:	e8 07 fd ff ff       	call   469 <write>
        while(*s != 0){
...
free(void *ap)
{
 ...
 785:	a1 9c 0c 00 00       	mov    0xc9c,%eax
{
 ...
 7a6:	73 10                	jae    7b8 <free+0x38>
{
 ...
 7d1:	5b                   	pop    %ebx
  freep = p;
 7d2:	a3 9c 0c 00 00       	mov    %eax,0xc9c
}
 7d7:	5e                   	pop    %esi
 7d8:	5f                   	pop    %edi
 7d9:	5d                   	pop    %ebp
 ...
 7f7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 7fa:	a3 9c 0c 00 00       	mov    %eax,0xc9c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 81d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 820:	8b 3d 9c 0c 00 00    	mov    0xc9c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 869:	8b 3d 9c 0c 00 00    	mov    0xc9c,%edi
 ...
 87b:	e8 51 fc ff ff       	call   4d1 <sbrk>
  if(p == (char*)-1)
 ...
 892:	e8 e9 fe ff ff       	call   780 <free>
  return freep;
 897:	a1 9c 0c 00 00       	mov    0xc9c,%eax
 ...
 8c4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 8c7:	a3 9c 0c 00 00       	mov    %eax,0xc9c
}
 ...
 8de:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 8e0:	c7 05 9c 0c 00 00 a0 	movl   $0xca0,0xc9c
 8e7:	0c 00 00 
    base.s.size = 0;
 8ea:	bf a0 0c 00 00       	mov    $0xca0,%edi
    base.s.ptr = freep = prevp = &base;
 8ef:	c7 05 a0 0c 00 00 a0 	movl   $0xca0,0xca0
 8f6:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 8f9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 8fb:	c7 05 a4 0c 00 00 00 	movl   $0x0,0xca4
 902:	00 00 00 
    if(p->s.size >= nunits){
