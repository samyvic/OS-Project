...
main(int argc, char *argv[])
{
  ...
  33:	ff 33                	pushl  (%ebx)
  35:	e8 9f 03 00 00       	call   3d9 <unlink>
...
printf(int fd, const char *fmt, ...)
{
 ...
 674:	eb 1a                	jmp    690 <printf+0x1a0>
          s = "(null)";
 676:	bb 85 08 00 00       	mov    $0x885,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6c5:	a1 e4 0b 00 00       	mov    0xbe4,%eax
{
 ...
 6e6:	73 10                	jae    6f8 <free+0x38>
{
 ...
 711:	5b                   	pop    %ebx
  freep = p;
 712:	a3 e4 0b 00 00       	mov    %eax,0xbe4
}
 717:	5e                   	pop    %esi
 718:	5f                   	pop    %edi
 719:	5d                   	pop    %ebp
 ...
 737:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 73a:	a3 e4 0b 00 00       	mov    %eax,0xbe4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 75d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 760:	8b 3d e4 0b 00 00    	mov    0xbe4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7a9:	8b 3d e4 0b 00 00    	mov    0xbe4,%edi
 ...
 7d2:	e8 e9 fe ff ff       	call   6c0 <free>
  return freep;
 7d7:	a1 e4 0b 00 00       	mov    0xbe4,%eax
 ...
 804:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 807:	a3 e4 0b 00 00       	mov    %eax,0xbe4
}
 ...
 81e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 820:	c7 05 e4 0b 00 00 e8 	movl   $0xbe8,0xbe4
 827:	0b 00 00 
    base.s.size = 0;
 82a:	bf e8 0b 00 00       	mov    $0xbe8,%edi
    base.s.ptr = freep = prevp = &base;
 82f:	c7 05 e8 0b 00 00 e8 	movl   $0xbe8,0xbe8
 836:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 839:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 83b:	c7 05 ec 0b 00 00 00 	movl   $0x0,0xbec
 842:	00 00 00 
    if(p->s.size >= nunits){
