...
main(void)
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
      ...
      2c:	6a 02                	push   $0x2
      2e:	68 a9 13 00 00       	push   $0x13a9
      33:	e8 41 0e 00 00       	call   e79 <open>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      48:	80 3d 82 1a 00 00 20 	cmpb   $0x20,0x1a82
...
fork1(void)
{
  ...
  pid = fork();
      58:	e8 d4 0d 00 00       	call   e31 <fork>
  if(pid == -1)
    ...
    wait();
      6e:	e8 ce 0d 00 00       	call   e41 <wait>
  while(getcmd(buf, sizeof(buf)) >= 0){
      73:	83 ec 08             	sub    $0x8,%esp
      76:	6a 64                	push   $0x64
      78:	68 80 1a 00 00       	push   $0x1a80
      7d:	e8 8e 00 00 00       	call   110 <getcmd>
      82:	83 c4 10             	add    $0x10,%esp
      85:	85 c0                	test   %eax,%eax
      87:	78 14                	js     9d <main+0x9d>
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      89:	80 3d 80 1a 00 00 63 	cmpb   $0x63,0x1a80
      90:	75 c6                	jne    58 <main+0x58>
      92:	80 3d 81 1a 00 00 64 	cmpb   $0x64,0x1a81
      99:	75 bd                	jne    58 <main+0x58>
      9b:	eb ab                	jmp    48 <main+0x48>
  exit();
      9d:	e8 97 0d 00 00       	call   e39 <exit>
      buf[strlen(buf)-1] = 0;  // chop \n
      a2:	83 ec 0c             	sub    $0xc,%esp
      a5:	68 80 1a 00 00       	push   $0x1a80
      aa:	e8 01 0b 00 00       	call   bb0 <strlen>
      if(chdir(buf+3) < 0)
      af:	c7 04 24 83 1a 00 00 	movl   $0x1a83,(%esp)
      buf[strlen(buf)-1] = 0;  // chop \n
      b6:	c6 80 7f 1a 00 00 00 	movb   $0x0,0x1a7f(%eax)
      if(chdir(buf+3) < 0)
      bd:	e8 e7 0d 00 00       	call   ea9 <chdir>
      c2:	83 c4 10             	add    $0x10,%esp
      c5:	85 c0                	test   %eax,%eax
      c7:	79 aa                	jns    73 <main+0x73>
        printf(2, "cannot cd %s\n", buf+3);
      c9:	50                   	push   %eax
      ca:	68 83 1a 00 00       	push   $0x1a83
      cf:	68 b1 13 00 00       	push   $0x13b1
      d4:	6a 02                	push   $0x2
      d6:	e8 c5 0e 00 00       	call   fa0 <printf>
      db:	83 c4 10             	add    $0x10,%esp
      de:	eb 93                	jmp    73 <main+0x73>
      close(fd);
      e0:	83 ec 0c             	sub    $0xc,%esp
      e3:	50                   	push   %eax
      e4:	e8 78 0d 00 00       	call   e61 <close>
      break;
      e9:	83 c4 10             	add    $0x10,%esp
      ec:	eb 85                	jmp    73 <main+0x73>
      runcmd(parsecmd(buf));
      ee:	83 ec 0c             	sub    $0xc,%esp
      f1:	68 80 1a 00 00       	push   $0x1a80
      f6:	e8 c5 09 00 00       	call   ac0 <parsecmd>
      fb:	89 04 24             	mov    %eax,(%esp)
      fe:	e8 7d 00 00 00       	call   180 <runcmd>
    panic("fork");
     103:	83 ec 0c             	sub    $0xc,%esp
     106:	68 32 13 00 00       	push   $0x1332
...
00000110 <getcmd>:
{
  ...
  printf(2, "$ ");
     ...
     122:	68 08 13 00 00       	push   $0x1308
     127:	6a 02                	push   $0x2
     129:	e8 72 0e 00 00       	call   fa0 <printf>
  memset(buf, 0, nbuf);
...
00000160 <panic>:
{
  ...
  printf(2, "%s\n", s);
     ...
     16d:	68 a5 13 00 00       	push   $0x13a5
     172:	6a 02                	push   $0x2
     174:	e8 27 0e 00 00       	call   fa0 <printf>
  exit();
     179:	e8 bb 0c 00 00       	call   e39 <exit>
...
00000180 <runcmd>:
{
  ...
  pid = fork();
     1d2:	e8 5a 0c 00 00       	call   e31 <fork>
  if(pid == -1)
    ...
    close(p[0]);
     ...
     1ee:	e8 6e 0c 00 00       	call   e61 <close>
    close(p[1]);
     1f3:	58                   	pop    %eax
     1f4:	ff 75 f4             	pushl  -0xc(%ebp)
     1f7:	e8 65 0c 00 00       	call   e61 <close>
    wait();
     1fc:	e8 40 0c 00 00       	call   e41 <wait>
    wait();
     201:	e8 3b 0c 00 00       	call   e41 <wait>
    break;
     206:	83 c4 10             	add    $0x10,%esp
     209:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    exit();
     210:	e8 24 0c 00 00       	call   e39 <exit>
  pid = fork();
     215:	e8 17 0c 00 00       	call   e31 <fork>
  if(pid == -1)
    ...
    exec(ecmd->argv[0], ecmd->argv);
     ...
     235:	52                   	push   %edx
     236:	50                   	push   %eax
     237:	e8 35 0c 00 00       	call   e71 <exec>
    printf(2, "exec %s failed\n", ecmd->argv[0]);
     23c:	83 c4 0c             	add    $0xc,%esp
     23f:	ff 73 04             	pushl  0x4(%ebx)
     242:	68 12 13 00 00       	push   $0x1312
     247:	6a 02                	push   $0x2
     249:	e8 52 0d 00 00       	call   fa0 <printf>
    break;
     24e:	83 c4 10             	add    $0x10,%esp
     251:	eb bd                	jmp    210 <runcmd+0x90>
  pid = fork();
     253:	e8 d9 0b 00 00       	call   e31 <fork>
  if(pid == -1)
    ...
    wait();
     265:	e8 d7 0b 00 00       	call   e41 <wait>
    runcmd(lcmd->right);
    ...
    close(rcmd->fd);
     ...
     27b:	e8 e1 0b 00 00       	call   e61 <close>
    if(open(rcmd->file, rcmd->mode) < 0){
     280:	58                   	pop    %eax
     281:	5a                   	pop    %edx
     282:	ff 73 10             	pushl  0x10(%ebx)
     285:	ff 73 08             	pushl  0x8(%ebx)
     288:	e8 ec 0b 00 00       	call   e79 <open>
    ...
    panic("runcmd");
     ...
     2a2:	68 0b 13 00 00       	push   $0x130b
     2a7:	e8 b4 fe ff ff       	call   160 <panic>
      printf(2, "open %s failed\n", rcmd->file);
     2ac:	51                   	push   %ecx
     2ad:	ff 73 08             	pushl  0x8(%ebx)
     2b0:	68 22 13 00 00       	push   $0x1322
     2b5:	6a 02                	push   $0x2
     2b7:	e8 e4 0c 00 00       	call   fa0 <printf>
      exit();
     2bc:	e8 78 0b 00 00       	call   e39 <exit>
      panic("pipe");
     2c1:	83 ec 0c             	sub    $0xc,%esp
     2c4:	68 37 13 00 00       	push   $0x1337
     2c9:	e8 92 fe ff ff       	call   160 <panic>
      close(1);
     2ce:	83 ec 0c             	sub    $0xc,%esp
     2d1:	6a 01                	push   $0x1
     2d3:	e8 89 0b 00 00       	call   e61 <close>
      dup(p[1]);
     2d8:	58                   	pop    %eax
     2d9:	ff 75 f4             	pushl  -0xc(%ebp)
     2dc:	e8 d0 0b 00 00       	call   eb1 <dup>
      close(p[0]);
     2e1:	58                   	pop    %eax
     2e2:	ff 75 f0             	pushl  -0x10(%ebp)
     2e5:	e8 77 0b 00 00       	call   e61 <close>
      close(p[1]);
     2ea:	58                   	pop    %eax
     2eb:	ff 75 f4             	pushl  -0xc(%ebp)
     2ee:	e8 6e 0b 00 00       	call   e61 <close>
      runcmd(pcmd->left);
     2f3:	5a                   	pop    %edx
     ...
     2ff:	6a 00                	push   $0x0
     301:	e8 5b 0b 00 00       	call   e61 <close>
      dup(p[0]);
     306:	5a                   	pop    %edx
     307:	ff 75 f0             	pushl  -0x10(%ebp)
     30a:	e8 a2 0b 00 00       	call   eb1 <dup>
      close(p[0]);
     30f:	59                   	pop    %ecx
     310:	ff 75 f0             	pushl  -0x10(%ebp)
     313:	e8 49 0b 00 00       	call   e61 <close>
      close(p[1]);
     318:	58                   	pop    %eax
     319:	ff 75 f4             	pushl  -0xc(%ebp)
     31c:	e8 40 0b 00 00       	call   e61 <close>
      runcmd(pcmd->right);
     321:	58                   	pop    %eax
    ...
    panic("fork");
     ...
     32d:	68 32 13 00 00       	push   $0x1332
...
00000340 <fork1>:
{
  ...
  pid = fork();
     34a:	e8 e2 0a 00 00       	call   e31 <fork>
  if(pid == -1)
  ...
  return pid;
    ...
    panic("fork");
     ...
     359:	68 32 13 00 00       	push   $0x1332
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     37b:	6a 54                	push   $0x54
     37d:	e8 7e 0e 00 00       	call   1200 <malloc>
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     3ab:	6a 18                	push   $0x18
     3ad:	e8 4e 0e 00 00       	call   1200 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     3fb:	6a 0c                	push   $0xc
     3fd:	e8 fe 0d 00 00       	call   1200 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     43b:	6a 0c                	push   $0xc
     43d:	e8 be 0d 00 00       	call   1200 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     47b:	6a 08                	push   $0x8
     47d:	e8 7e 0d 00 00       	call   1200 <malloc>
  memset(cmd, 0, sizeof(*cmd));
     ...
     4bd:	8b 45 08             	mov    0x8(%ebp),%eax
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     4dd:	50                   	push   %eax
     4de:	68 70 1a 00 00       	push   $0x1a70
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     52d:	50                   	push   %eax
     52e:	68 70 1a 00 00       	push   $0x1a70
  ...
  *ps = s;
  ...
  if(eq)
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     56e:	50                   	push   %eax
     56f:	68 68 1a 00 00       	push   $0x1a68
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     590:	56                   	push   %esi
     591:	68 70 1a 00 00       	push   $0x1a70
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     63d:	50                   	push   %eax
     63e:	68 70 1a 00 00       	push   $0x1a70
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     6ab:	68 59 13 00 00       	push   $0x1359
     6b0:	53                   	push   %ebx
     6b1:	56                   	push   %esi
  ...
  return cmd;
     ...
     736:	68 3c 13 00 00       	push   $0x133c
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     753:	68 5c 13 00 00       	push   $0x135c
     758:	57                   	push   %edi
     759:	56                   	push   %esi
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     7a6:	68 73 13 00 00       	push   $0x1373
     7ab:	57                   	push   %edi
     7ac:	56                   	push   %esi
    ...
    if(argc >= MAXARGS)
     ...
     7f0:	68 65 13 00 00       	push   $0x1365
  ...
  cmd->eargv[argc] = 0;
     ...
     842:	68 5e 13 00 00       	push   $0x135e
...
00000850 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     86d:	68 78 13 00 00       	push   $0x1378
  cmd = parseexec(ps, es);
...
000008c0 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     903:	68 7a 13 00 00       	push   $0x137a
     908:	57                   	push   %edi
     909:	56                   	push   %esi
  ...
  if(peek(ps, es, ";")){
     ...
     919:	68 76 13 00 00       	push   $0x1376
     91e:	57                   	push   %edi
     91f:	56                   	push   %esi
...
00000970 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     983:	68 5c 13 00 00       	push   $0x135c
     988:	56                   	push   %esi
     989:	53                   	push   %ebx
  ...
  if(!peek(ps, es, ")"))
     ...
     9ad:	68 98 13 00 00       	push   $0x1398
  cmd = parseline(ps, es);
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     a1d:	3e ff 24 85 d8 13 00 	notrack jmp *0x13d8(,%eax,4)
     a24:	00 
...
00000ac0 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     aeb:	68 21 13 00 00       	push   $0x1321
     af0:	53                   	push   %ebx
     af1:	50                   	push   %eax
  ...
  nulterminate(cmd);
    ...
    printf(2, "leftovers: %s\n", s);
     b13:	52                   	push   %edx
     b14:	50                   	push   %eax
     b15:	68 9a 13 00 00       	push   $0x139a
     b1a:	6a 02                	push   $0x2
     b1c:	e8 7f 04 00 00       	call   fa0 <printf>
    panic("syntax");
     b21:	c7 04 24 5e 13 00 00 	movl   $0x135e,(%esp)
     ...
     c59:	31 f6                	xor    %esi,%esi
{
  ...
  for(i=0; i+1 < max; ){
    ...
    cc = read(0, &c, 1);
     ...
     c78:	50                   	push   %eax
     c79:	6a 00                	push   $0x0
     c7b:	e8 d1 01 00 00       	call   e51 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
     ...
     ce1:	e8 93 01 00 00       	call   e79 <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
     ...
     cf5:	50                   	push   %eax
     cf6:	e8 96 01 00 00       	call   e91 <fstat>
  close(fd);
     cfb:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
     cfe:	89 c6                	mov    %eax,%esi
  close(fd);
     d00:	e8 5c 01 00 00       	call   e61 <close>
  return r;
...
thread_create(void(*start_routine)(void*,void*),void* arg1 ,void* arg2)
{
     ...
     d97:	83 ec 14             	sub    $0x14,%esp
void* stack;
stack =sbrk(4096);  //pgsize
     d9a:	68 00 10 00 00       	push   $0x1000
     d9f:	e8 1d 01 00 00       	call   ec1 <sbrk>
return clone(start_routine,arg1,arg2,stack);
     da4:	50                   	push   %eax
     da5:	ff 75 10             	pushl  0x10(%ebp)
     da8:	ff 75 0c             	pushl  0xc(%ebp)
     dab:	ff 75 08             	pushl  0x8(%ebp)
     dae:	e8 26 01 00 00       	call   ed9 <clone>
}
     db3:	c9                   	leave  
     db4:	c3                   	ret    
...
00000dc0 <thread_join>:
int thread_join()
{
     dc0:	f3 0f 1e fb          	endbr32 
     dc4:	55                   	push   %ebp
     dc5:	89 e5                	mov    %esp,%ebp
     dc7:	83 ec 24             	sub    $0x24,%esp
  void * stackPtr;
  int x = join(&stackPtr);
     dca:	8d 45 f4             	lea    -0xc(%ebp),%eax
     dcd:	50                   	push   %eax
     dce:	e8 0e 01 00 00       	call   ee1 <join>
  
  return x;
}
     dd3:	c9                   	leave  
     dd4:	c3                   	ret    
     dd5:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
lk->locked=0; //intialize as unnlocked
     ...
     dea:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
}
     df0:	5d                   	pop    %ebp
     df1:	c3                   	ret    
...
00000e20 <lock_release>:
void lock_release(struct lock_t *lk){
     e20:	f3 0f 1e fb          	endbr32 
     e24:	55                   	push   %ebp
     e25:	31 c0                	xor    %eax,%eax
     e27:	89 e5                	mov    %esp,%ebp
     e29:	8b 55 08             	mov    0x8(%ebp),%edx
     e2c:	f0 87 02             	lock xchg %eax,(%edx)
  xchg(&lk->locked,0) ;
}
     e2f:	5d                   	pop    %ebp
     e30:	c3                   	ret    
...
SYSCALL(fork)
     e31:	b8 01 00 00 00       	mov    $0x1,%eax
     e36:	cd 40                	int    $0x40
     e38:	c3                   	ret    

00000e39 <exit>:
SYSCALL(exit)
     e39:	b8 02 00 00 00       	mov    $0x2,%eax
     e3e:	cd 40                	int    $0x40
     e40:	c3                   	ret    

00000e41 <wait>:
SYSCALL(wait)
     e41:	b8 03 00 00 00       	mov    $0x3,%eax
     e46:	cd 40                	int    $0x40
     e48:	c3                   	ret    

00000e49 <pipe>:
SYSCALL(pipe)
     e49:	b8 04 00 00 00       	mov    $0x4,%eax
     e4e:	cd 40                	int    $0x40
     e50:	c3                   	ret    

00000e51 <read>:
SYSCALL(read)
     e51:	b8 05 00 00 00       	mov    $0x5,%eax
     e56:	cd 40                	int    $0x40
     e58:	c3                   	ret    

00000e59 <write>:
SYSCALL(write)
     e59:	b8 10 00 00 00       	mov    $0x10,%eax
     e5e:	cd 40                	int    $0x40
     e60:	c3                   	ret    

00000e61 <close>:
SYSCALL(close)
     e61:	b8 15 00 00 00       	mov    $0x15,%eax
     e66:	cd 40                	int    $0x40
     e68:	c3                   	ret    

00000e69 <kill>:
SYSCALL(kill)
     e69:	b8 06 00 00 00       	mov    $0x6,%eax
     e6e:	cd 40                	int    $0x40
     e70:	c3                   	ret    

00000e71 <exec>:
SYSCALL(exec)
     e71:	b8 07 00 00 00       	mov    $0x7,%eax
     e76:	cd 40                	int    $0x40
     e78:	c3                   	ret    

00000e79 <open>:
SYSCALL(open)
     e79:	b8 0f 00 00 00       	mov    $0xf,%eax
     e7e:	cd 40                	int    $0x40
     e80:	c3                   	ret    

00000e81 <mknod>:
SYSCALL(mknod)
     e81:	b8 11 00 00 00       	mov    $0x11,%eax
     e86:	cd 40                	int    $0x40
     e88:	c3                   	ret    

00000e89 <unlink>:
SYSCALL(unlink)
     e89:	b8 12 00 00 00       	mov    $0x12,%eax
     e8e:	cd 40                	int    $0x40
     e90:	c3                   	ret    

00000e91 <fstat>:
SYSCALL(fstat)
     e91:	b8 08 00 00 00       	mov    $0x8,%eax
     e96:	cd 40                	int    $0x40
     e98:	c3                   	ret    

00000e99 <link>:
SYSCALL(link)
     e99:	b8 13 00 00 00       	mov    $0x13,%eax
     e9e:	cd 40                	int    $0x40
     ea0:	c3                   	ret    

00000ea1 <mkdir>:
SYSCALL(mkdir)
     ea1:	b8 14 00 00 00       	mov    $0x14,%eax
     ea6:	cd 40                	int    $0x40
     ea8:	c3                   	ret    

00000ea9 <chdir>:
SYSCALL(chdir)
     ea9:	b8 09 00 00 00       	mov    $0x9,%eax
     eae:	cd 40                	int    $0x40
     eb0:	c3                   	ret    

00000eb1 <dup>:
SYSCALL(dup)
     eb1:	b8 0a 00 00 00       	mov    $0xa,%eax
     eb6:	cd 40                	int    $0x40
     eb8:	c3                   	ret    

00000eb9 <getpid>:
SYSCALL(getpid)
     eb9:	b8 0b 00 00 00       	mov    $0xb,%eax
     ebe:	cd 40                	int    $0x40
     ec0:	c3                   	ret    

00000ec1 <sbrk>:
SYSCALL(sbrk)
     ec1:	b8 0c 00 00 00       	mov    $0xc,%eax
     ec6:	cd 40                	int    $0x40
     ec8:	c3                   	ret    

00000ec9 <sleep>:
SYSCALL(sleep)
     ec9:	b8 0d 00 00 00       	mov    $0xd,%eax
     ece:	cd 40                	int    $0x40
     ed0:	c3                   	ret    

00000ed1 <uptime>:
SYSCALL(uptime)
     ed1:	b8 0e 00 00 00       	mov    $0xe,%eax
     ed6:	cd 40                	int    $0x40
     ed8:	c3                   	ret    

00000ed9 <clone>:
SYSCALL(clone)
     ed9:	b8 16 00 00 00       	mov    $0x16,%eax
     ede:	cd 40                	int    $0x40
     ee0:	c3                   	ret    

00000ee1 <join>:
     ee1:	b8 17 00 00 00       	mov    $0x17,%eax
     ee6:	cd 40                	int    $0x40
     ee8:	c3                   	ret    
     ...
     efc:	89 d1                	mov    %edx,%ecx
{
  ...
  write(fd, &c, 1);
     ...
     f6e:	56                   	push   %esi
     f6f:	57                   	push   %edi
     f70:	e8 e4 fe ff ff       	call   e59 <write>
  while(--i >= 0)
...
printf(int fd, const char *fmt, ...)
{
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
     fad:	8b 75 0c             	mov    0xc(%ebp),%esi
     fb0:	0f b6 1e             	movzbl (%esi),%ebx
     fb3:	84 db                	test   %bl,%bl
     fb5:	0f 84 b4 00 00 00    	je     106f <printf+0xcf>
  ap = (uint*)(void*)&fmt + 1;
     fbb:	8d 45 10             	lea    0x10(%ebp),%eax
     fbe:	83 c6 01             	add    $0x1,%esi
  write(fd, &c, 1);
     fc1:	8d 7d e7             	lea    -0x19(%ebp),%edi
  state = 0;
     fc4:	31 d2                	xor    %edx,%edx
  ap = (uint*)(void*)&fmt + 1;
     fc6:	89 45 d0             	mov    %eax,-0x30(%ebp)
     fc9:	eb 33                	jmp    ffe <printf+0x5e>
    ...
    if(state == 0){
      if(c == '%'){
        state = '%';
     fd3:	ba 25 00 00 00       	mov    $0x25,%edx
      if(c == '%'){
     fd8:	83 f8 25             	cmp    $0x25,%eax
     fdb:	74 17                	je     ff4 <printf+0x54>
  write(fd, &c, 1);
     fdd:	83 ec 04             	sub    $0x4,%esp
     fe0:	88 5d e7             	mov    %bl,-0x19(%ebp)
     fe3:	6a 01                	push   $0x1
     fe5:	57                   	push   %edi
     fe6:	ff 75 08             	pushl  0x8(%ebp)
     fe9:	e8 6b fe ff ff       	call   e59 <write>
     fee:	8b 55 d4             	mov    -0x2c(%ebp),%edx
      } else {
        putc(fd, c);
     ff1:	83 c4 10             	add    $0x10,%esp
  for(i = 0; fmt[i]; i++){
     ff4:	0f b6 1e             	movzbl (%esi),%ebx
     ff7:	83 c6 01             	add    $0x1,%esi
     ffa:	84 db                	test   %bl,%bl
     ffc:	74 71                	je     106f <printf+0xcf>
    c = fmt[i] & 0xff;
     ffe:	0f be cb             	movsbl %bl,%ecx
    1001:	0f b6 c3             	movzbl %bl,%eax
    if(state == 0){
    1004:	85 d2                	test   %edx,%edx
    1006:	74 c8                	je     fd0 <printf+0x30>
      }
    } else if(state == '%'){
    1008:	83 fa 25             	cmp    $0x25,%edx
    100b:	75 e7                	jne    ff4 <printf+0x54>
      if(c == 'd'){
    100d:	83 f8 64             	cmp    $0x64,%eax
    1010:	0f 84 9a 00 00 00    	je     10b0 <printf+0x110>
        printint(fd, *ap, 10, 1);
        ap++;
      } else if(c == 'x' || c == 'p'){
    1016:	81 e1 f7 00 00 00    	and    $0xf7,%ecx
    101c:	83 f9 70             	cmp    $0x70,%ecx
    101f:	74 5f                	je     1080 <printf+0xe0>
        printint(fd, *ap, 16, 0);
        ap++;
      } else if(c == 's'){
    1021:	83 f8 73             	cmp    $0x73,%eax
    1024:	0f 84 d6 00 00 00    	je     1100 <printf+0x160>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
    ...
    102a:	83 f8 63             	cmp    $0x63,%eax
    102d:	0f 84 8d 00 00 00    	je     10c0 <printf+0x120>
        putc(fd, *ap);
        ap++;
      } else if(c == '%'){
    1033:	83 f8 25             	cmp    $0x25,%eax
    1036:	0f 84 b4 00 00 00    	je     10f0 <printf+0x150>
  write(fd, &c, 1);
    103c:	83 ec 04             	sub    $0x4,%esp
    103f:	c6 45 e7 25          	movb   $0x25,-0x19(%ebp)
    1043:	6a 01                	push   $0x1
    1045:	57                   	push   %edi
    1046:	ff 75 08             	pushl  0x8(%ebp)
    1049:	e8 0b fe ff ff       	call   e59 <write>
        putc(fd, c);
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
        putc(fd, c);
    104e:	88 5d e7             	mov    %bl,-0x19(%ebp)
  write(fd, &c, 1);
    1051:	83 c4 0c             	add    $0xc,%esp
    1054:	6a 01                	push   $0x1
    1056:	83 c6 01             	add    $0x1,%esi
    1059:	57                   	push   %edi
    105a:	ff 75 08             	pushl  0x8(%ebp)
    105d:	e8 f7 fd ff ff       	call   e59 <write>
  for(i = 0; fmt[i]; i++){
    1062:	0f b6 5e ff          	movzbl -0x1(%esi),%ebx
        putc(fd, c);
    1066:	83 c4 10             	add    $0x10,%esp
      }
      state = 0;
    1069:	31 d2                	xor    %edx,%edx
  for(i = 0; fmt[i]; i++){
    106b:	84 db                	test   %bl,%bl
    106d:	75 8f                	jne    ffe <printf+0x5e>
    }
  }
}
    106f:	8d 65 f4             	lea    -0xc(%ebp),%esp
    1072:	5b                   	pop    %ebx
    1073:	5e                   	pop    %esi
    1074:	5f                   	pop    %edi
    1075:	5d                   	pop    %ebp
    ...
    1083:	b9 10 00 00 00       	mov    $0x10,%ecx
    1088:	6a 00                	push   $0x0
    108a:	8b 5d d0             	mov    -0x30(%ebp),%ebx
    108d:	8b 45 08             	mov    0x8(%ebp),%eax
    1090:	8b 13                	mov    (%ebx),%edx
    1092:	e8 59 fe ff ff       	call   ef0 <printint>
        ap++;
    1097:	89 d8                	mov    %ebx,%eax
    1099:	83 c4 10             	add    $0x10,%esp
      state = 0;
    109c:	31 d2                	xor    %edx,%edx
        ap++;
    109e:	83 c0 04             	add    $0x4,%eax
    10a1:	89 45 d0             	mov    %eax,-0x30(%ebp)
    10a4:	e9 4b ff ff ff       	jmp    ff4 <printf+0x54>
    10a9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        printint(fd, *ap, 10, 1);
    10b0:	83 ec 0c             	sub    $0xc,%esp
    10b3:	b9 0a 00 00 00       	mov    $0xa,%ecx
    10b8:	6a 01                	push   $0x1
    10ba:	eb ce                	jmp    108a <printf+0xea>
  ...
  write(fd, &c, 1);
    10c3:	83 ec 04             	sub    $0x4,%esp
        putc(fd, *ap);
    10c6:	8b 03                	mov    (%ebx),%eax
  write(fd, &c, 1);
    10c8:	6a 01                	push   $0x1
        ap++;
    10ca:	83 c3 04             	add    $0x4,%ebx
  write(fd, &c, 1);
    10cd:	57                   	push   %edi
    10ce:	ff 75 08             	pushl  0x8(%ebp)
        putc(fd, *ap);
    10d1:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
    10d4:	e8 80 fd ff ff       	call   e59 <write>
        ap++;
    10d9:	89 5d d0             	mov    %ebx,-0x30(%ebp)
    10dc:	83 c4 10             	add    $0x10,%esp
      state = 0;
    10df:	31 d2                	xor    %edx,%edx
    10e1:	e9 0e ff ff ff       	jmp    ff4 <printf+0x54>
    10e6:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    10ed:	8d 76 00             	lea    0x0(%esi),%esi
        putc(fd, c);
    10f0:	88 5d e7             	mov    %bl,-0x19(%ebp)
  write(fd, &c, 1);
    10f3:	83 ec 04             	sub    $0x4,%esp
    10f6:	e9 59 ff ff ff       	jmp    1054 <printf+0xb4>
    10fb:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    10ff:	90                   	nop
        s = (char*)*ap;
    1100:	8b 45 d0             	mov    -0x30(%ebp),%eax
    1103:	8b 18                	mov    (%eax),%ebx
        ap++;
    1105:	83 c0 04             	add    $0x4,%eax
    1108:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
    110b:	85 db                	test   %ebx,%ebx
    110d:	74 17                	je     1126 <printf+0x186>
        while(*s != 0){
    110f:	0f b6 03             	movzbl (%ebx),%eax
      state = 0;
    1112:	31 d2                	xor    %edx,%edx
        while(*s != 0){
    1114:	84 c0                	test   %al,%al
    1116:	0f 84 d8 fe ff ff    	je     ff4 <printf+0x54>
    111c:	89 75 d4             	mov    %esi,-0x2c(%ebp)
    111f:	89 de                	mov    %ebx,%esi
    1121:	8b 5d 08             	mov    0x8(%ebp),%ebx
    1124:	eb 1a                	jmp    1140 <printf+0x1a0>
          s = "(null)";
    1126:	bb f0 13 00 00       	mov    $0x13f0,%ebx
        while(*s != 0){
    112b:	89 75 d4             	mov    %esi,-0x2c(%ebp)
    112e:	b8 28 00 00 00       	mov    $0x28,%eax
    1133:	89 de                	mov    %ebx,%esi
  ...
  write(fd, &c, 1);
    1140:	83 ec 04             	sub    $0x4,%esp
          s++;
    1143:	83 c6 01             	add    $0x1,%esi
    1146:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
    1149:	6a 01                	push   $0x1
    114b:	57                   	push   %edi
    114c:	53                   	push   %ebx
    114d:	e8 07 fd ff ff       	call   e59 <write>
        while(*s != 0){
    1152:	0f b6 06             	movzbl (%esi),%eax
    1155:	83 c4 10             	add    $0x10,%esp
    1158:	84 c0                	test   %al,%al
    115a:	75 e4                	jne    1140 <printf+0x1a0>
    115c:	8b 75 d4             	mov    -0x2c(%ebp),%esi
      state = 0;
    115f:	31 d2                	xor    %edx,%edx
    1161:	e9 8e fe ff ff       	jmp    ff4 <printf+0x54>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1175:	a1 e4 1a 00 00       	mov    0x1ae4,%eax
{
    117a:	89 e5                	mov    %esp,%ebp
    117c:	57                   	push   %edi
    117d:	56                   	push   %esi
    117e:	53                   	push   %ebx
    117f:	8b 5d 08             	mov    0x8(%ebp),%ebx
    1182:	8b 10                	mov    (%eax),%edx
  bp = (Header*)ap - 1;
    1184:	8d 4b f8             	lea    -0x8(%ebx),%ecx
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1187:	39 c8                	cmp    %ecx,%eax
    1189:	73 15                	jae    11a0 <free+0x30>
    118b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    118f:	90                   	nop
    1190:	39 d1                	cmp    %edx,%ecx
    1192:	72 14                	jb     11a8 <free+0x38>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    1194:	39 d0                	cmp    %edx,%eax
    1196:	73 10                	jae    11a8 <free+0x38>
{
    1198:	89 d0                	mov    %edx,%eax
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    119a:	8b 10                	mov    (%eax),%edx
    119c:	39 c8                	cmp    %ecx,%eax
    119e:	72 f0                	jb     1190 <free+0x20>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    11a0:	39 d0                	cmp    %edx,%eax
    11a2:	72 f4                	jb     1198 <free+0x28>
    11a4:	39 d1                	cmp    %edx,%ecx
    11a6:	73 f0                	jae    1198 <free+0x28>
      break;
  if(bp + bp->s.size == p->s.ptr){
    11a8:	8b 73 fc             	mov    -0x4(%ebx),%esi
    11ab:	8d 3c f1             	lea    (%ecx,%esi,8),%edi
    11ae:	39 fa                	cmp    %edi,%edx
    11b0:	74 1e                	je     11d0 <free+0x60>
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
    11b2:	89 53 f8             	mov    %edx,-0x8(%ebx)
  if(p + p->s.size == bp){
    11b5:	8b 50 04             	mov    0x4(%eax),%edx
    11b8:	8d 34 d0             	lea    (%eax,%edx,8),%esi
    11bb:	39 f1                	cmp    %esi,%ecx
    11bd:	74 28                	je     11e7 <free+0x77>
    p->s.size += bp->s.size;
    p->s.ptr = bp->s.ptr;
  } else
    p->s.ptr = bp;
    11bf:	89 08                	mov    %ecx,(%eax)
  freep = p;
}
    11c1:	5b                   	pop    %ebx
  freep = p;
    11c2:	a3 e4 1a 00 00       	mov    %eax,0x1ae4
}
    11c7:	5e                   	pop    %esi
    11c8:	5f                   	pop    %edi
    11c9:	5d                   	pop    %ebp
  ...
  if(p + p->s.size == bp){
    ...
    11e5:	75 d8                	jne    11bf <free+0x4f>
    p->s.size += bp->s.size;
    11e7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
    11ea:	a3 e4 1a 00 00       	mov    %eax,0x1ae4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    1210:	8b 3d e4 1a 00 00    	mov    0x1ae4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    1216:	8d 70 07             	lea    0x7(%eax),%esi
    1219:	c1 ee 03             	shr    $0x3,%esi
    121c:	83 c6 01             	add    $0x1,%esi
  if((prevp = freep) == 0){
    121f:	85 ff                	test   %edi,%edi
    1221:	0f 84 a9 00 00 00    	je     12d0 <malloc+0xd0>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1227:	8b 07                	mov    (%edi),%eax
    if(p->s.size >= nunits){
    1229:	8b 48 04             	mov    0x4(%eax),%ecx
    122c:	39 f1                	cmp    %esi,%ecx
    122e:	73 6d                	jae    129d <malloc+0x9d>
    1230:	81 fe 00 10 00 00    	cmp    $0x1000,%esi
    1236:	bb 00 10 00 00       	mov    $0x1000,%ebx
    123b:	0f 43 de             	cmovae %esi,%ebx
  p = sbrk(nu * sizeof(Header));
    123e:	8d 0c dd 00 00 00 00 	lea    0x0(,%ebx,8),%ecx
    1245:	89 4d e4             	mov    %ecx,-0x1c(%ebp)
    1248:	eb 17                	jmp    1261 <malloc+0x61>
    124a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1250:	8b 10                	mov    (%eax),%edx
    if(p->s.size >= nunits){
    1252:	8b 4a 04             	mov    0x4(%edx),%ecx
    1255:	39 f1                	cmp    %esi,%ecx
    1257:	73 4f                	jae    12a8 <malloc+0xa8>
    1259:	8b 3d e4 1a 00 00    	mov    0x1ae4,%edi
    125f:	89 d0                	mov    %edx,%eax
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    1261:	39 c7                	cmp    %eax,%edi
    1263:	75 eb                	jne    1250 <malloc+0x50>
  p = sbrk(nu * sizeof(Header));
    1265:	83 ec 0c             	sub    $0xc,%esp
    1268:	ff 75 e4             	pushl  -0x1c(%ebp)
    126b:	e8 51 fc ff ff       	call   ec1 <sbrk>
  if(p == (char*)-1)
    1270:	83 c4 10             	add    $0x10,%esp
    1273:	83 f8 ff             	cmp    $0xffffffff,%eax
    1276:	74 1b                	je     1293 <malloc+0x93>
  hp->s.size = nu;
    1278:	89 58 04             	mov    %ebx,0x4(%eax)
  free((void*)(hp + 1));
    127b:	83 ec 0c             	sub    $0xc,%esp
    127e:	83 c0 08             	add    $0x8,%eax
    1281:	50                   	push   %eax
    1282:	e8 e9 fe ff ff       	call   1170 <free>
  return freep;
    1287:	a1 e4 1a 00 00       	mov    0x1ae4,%eax
      if((p = morecore(nunits)) == 0)
    128c:	83 c4 10             	add    $0x10,%esp
    128f:	85 c0                	test   %eax,%eax
    1291:	75 bd                	jne    1250 <malloc+0x50>
        return 0;
  }
}
    ...
    12a1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      if(p->s.size == nunits)
    12a8:	39 ce                	cmp    %ecx,%esi
    12aa:	74 54                	je     1300 <malloc+0x100>
        p->s.size -= nunits;
    12ac:	29 f1                	sub    %esi,%ecx
    12ae:	89 4a 04             	mov    %ecx,0x4(%edx)
        p += p->s.size;
    12b1:	8d 14 ca             	lea    (%edx,%ecx,8),%edx
        p->s.size = nunits;
    12b4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
    12b7:	a3 e4 1a 00 00       	mov    %eax,0x1ae4
}
    12bc:	8d 65 f4             	lea    -0xc(%ebp),%esp
      return (void*)(p + 1);
    12bf:	8d 42 08             	lea    0x8(%edx),%eax
}
    12c2:	5b                   	pop    %ebx
    12c3:	5e                   	pop    %esi
    12c4:	5f                   	pop    %edi
    ...
    base.s.ptr = freep = prevp = &base;
    12d0:	c7 05 e4 1a 00 00 e8 	movl   $0x1ae8,0x1ae4
    12d7:	1a 00 00 
    base.s.size = 0;
    12da:	bf e8 1a 00 00       	mov    $0x1ae8,%edi
    base.s.ptr = freep = prevp = &base;
    12df:	c7 05 e8 1a 00 00 e8 	movl   $0x1ae8,0x1ae8
    12e6:	1a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    12e9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
    12eb:	c7 05 ec 1a 00 00 00 	movl   $0x0,0x1aec
    12f2:	00 00 00 
    if(p->s.size >= nunits){
    12f5:	e9 36 ff ff ff       	jmp    1230 <malloc+0x30>
    12fa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        prevp->s.ptr = p->s.ptr;
    1300:	8b 0a                	mov    (%edx),%ecx
    1302:	89 08                	mov    %ecx,(%eax)
    1304:	eb b1                	jmp    12b7 <malloc+0xb7>
