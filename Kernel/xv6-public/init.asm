...
main(void)
{
  ...
  16:	6a 02                	push   $0x2
  18:	68 c8 08 00 00       	push   $0x8c8
  1d:	e8 17 04 00 00       	call   439 <open>
  ...
  30:	6a 00                	push   $0x0
  32:	e8 3a 04 00 00       	call   471 <dup>
  dup(0);  // stderr
  37:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  3e:	e8 2e 04 00 00       	call   471 <dup>
  ...
  53:	68 d0 08 00 00       	push   $0x8d0
  58:	6a 01                	push   $0x1
  5a:	e8 01 05 00 00       	call   560 <printf>
    pid = fork();
  5f:	e8 8d 03 00 00       	call   3f1 <fork>
    if(pid < 0){
  ...
  70:	e8 8c 03 00 00       	call   401 <wait>
  ...
  9a:	e8 c1 04 00 00       	call   560 <printf>
      exit();
  9f:	e8 55 03 00 00       	call   3f9 <exit>
      exec("sh", argv);
  a4:	50                   	push   %eax
  a5:	50                   	push   %eax
  a6:	68 6c 0c 00 00       	push   $0xc6c
  ab:	68 f6 08 00 00       	push   $0x8f6
  b0:	e8 7c 03 00 00       	call   431 <exec>
      printf(1, "init: exec sh failed\n");
  b5:	5a                   	pop    %edx
  b6:	59                   	pop    %ecx
  ...
  be:	e8 9d 04 00 00       	call   560 <printf>
      exit();
  c3:	e8 31 03 00 00       	call   3f9 <exit>
    mknod("console", 1, 1);
  c8:	50                   	push   %eax
  c9:	6a 01                	push   $0x1
  cb:	6a 01                	push   $0x1
  cd:	68 c8 08 00 00       	push   $0x8c8
  d2:	e8 6a 03 00 00       	call   441 <mknod>
    open("console", O_RDWR);
  d7:	58                   	pop    %eax
  d8:	5a                   	pop    %edx
  d9:	6a 02                	push   $0x2
  db:	68 c8 08 00 00       	push   $0x8c8
  e0:	e8 54 03 00 00       	call   439 <open>
...
printf(int fd, const char *fmt, ...)
{
 ...
 6e4:	eb 1a                	jmp    700 <printf+0x1a0>
          s = "(null)";
 6e6:	bb 18 09 00 00       	mov    $0x918,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 735:	a1 74 0c 00 00       	mov    0xc74,%eax
{
 ...
 756:	73 10                	jae    768 <free+0x38>
{
 ...
 7a7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 7aa:	a3 74 0c 00 00       	mov    %eax,0xc74
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7cd:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7d0:	8b 3d 74 0c 00 00    	mov    0xc74,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 819:	8b 3d 74 0c 00 00    	mov    0xc74,%edi
 ...
 842:	e8 e9 fe ff ff       	call   730 <free>
  return freep;
 847:	a1 74 0c 00 00       	mov    0xc74,%eax
 ...
 874:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 877:	a3 74 0c 00 00       	mov    %eax,0xc74
}
 ...
 88e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 890:	c7 05 74 0c 00 00 78 	movl   $0xc78,0xc74
 897:	0c 00 00 
    base.s.size = 0;
 89a:	bf 78 0c 00 00       	mov    $0xc78,%edi
    base.s.ptr = freep = prevp = &base;
 89f:	c7 05 78 0c 00 00 78 	movl   $0xc78,0xc78
 8a6:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 8a9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 8ab:	c7 05 7c 0c 00 00 00 	movl   $0x0,0xc7c
 8b2:	00 00 00 
    if(p->s.size >= nunits){
