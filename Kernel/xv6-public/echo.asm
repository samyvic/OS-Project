...
main(int argc, char *argv[])
{
  ...
  57:	68 5f 08 00 00       	push   $0x85f
  5c:	50                   	push   %eax
  5d:	68 5a 08 00 00       	push   $0x85a
  62:	6a 01                	push   $0x1
  64:	e8 87 04 00 00       	call   4f0 <printf>
  69:	83 c4 10             	add    $0x10,%esp
  exit();
  6c:	e8 18 03 00 00       	call   389 <exit>
  71:	66 90                	xchg   %ax,%ax
  73:	66 90                	xchg   %ax,%ax
  75:	66 90                	xchg   %ax,%ax
  77:	66 90                	xchg   %ax,%ax
 ...
 44c:	89 d1                	mov    %edx,%ecx
{
 ...
 479:	0f b6 92 68 08 00 00 	movzbl 0x868(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 674:	eb 1a                	jmp    690 <printf+0x1a0>
          s = "(null)";
 676:	bb 61 08 00 00       	mov    $0x861,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6c5:	a1 b8 0b 00 00       	mov    0xbb8,%eax
{
 ...
 6e6:	73 10                	jae    6f8 <free+0x38>
{
 ...
 711:	5b                   	pop    %ebx
  freep = p;
 712:	a3 b8 0b 00 00       	mov    %eax,0xbb8
}
 717:	5e                   	pop    %esi
 718:	5f                   	pop    %edi
 719:	5d                   	pop    %ebp
 ...
 737:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 73a:	a3 b8 0b 00 00       	mov    %eax,0xbb8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 75d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 760:	8b 3d b8 0b 00 00    	mov    0xbb8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7a9:	8b 3d b8 0b 00 00    	mov    0xbb8,%edi
 ...
 7d2:	e8 e9 fe ff ff       	call   6c0 <free>
  return freep;
 7d7:	a1 b8 0b 00 00       	mov    0xbb8,%eax
 ...
 81e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 820:	c7 05 b8 0b 00 00 bc 	movl   $0xbbc,0xbb8
 827:	0b 00 00 
    base.s.size = 0;
 82a:	bf bc 0b 00 00       	mov    $0xbbc,%edi
    base.s.ptr = freep = prevp = &base;
 82f:	c7 05 bc 0b 00 00 bc 	movl   $0xbbc,0xbbc
 836:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 839:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 83b:	c7 05 c0 0b 00 00 00 	movl   $0x0,0xbc0
 842:	00 00 00 
    if(p->s.size >= nunits){
