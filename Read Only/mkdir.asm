...
main(int argc, char *argv[])
{
  ...
  2b:	ff 33                	pushl  (%ebx)
  2d:	e8 57 02 00 00       	call   289 <mkdir>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 308:	8a 92 a4 06 00 00    	mov    0x6a4(%edx),%dl
...
printf(int fd, const char *fmt, ...)
{
 ...
 4d3:	e9 c9 fe ff ff       	jmp    3a1 <printf+0x45>
          s = "(null)";
 4d8:	bb 9b 06 00 00       	mov    $0x69b,%ebx
        while(*s != 0){
 ...
 50e:	73 10                	jae    520 <free+0x30>
{
 ...
 537:	89 08                	mov    %ecx,(%eax)
  freep = p;
 539:	a3 48 09 00 00       	mov    %eax,0x948
}
 53e:	5b                   	pop    %ebx
 53f:	5e                   	pop    %esi
 540:	5f                   	pop    %edi
 ...
 564:	89 10                	mov    %edx,(%eax)
  freep = p;
 566:	a3 48 09 00 00       	mov    %eax,0x948
}
 56b:	5b                   	pop    %ebx
 56c:	5e                   	pop    %esi
 56d:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 582:	46                   	inc    %esi
  if((prevp = freep) == 0){
 583:	8b 3d 48 09 00 00    	mov    0x948,%edi
 ...
 5bd:	8b 3d 48 09 00 00    	mov    0x948,%edi
 ...
 5e6:	e8 05 ff ff ff       	call   4f0 <free>
  return freep;
 5eb:	a1 48 09 00 00       	mov    0x948,%eax
 ...
 614:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 617:	a3 48 09 00 00       	mov    %eax,0x948
      return (void*)(p + 1);
 ...
 632:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 634:	c7 05 48 09 00 00 4c 	movl   $0x94c,0x948
 63b:	09 00 00 
 63e:	c7 05 4c 09 00 00 4c 	movl   $0x94c,0x94c
 645:	09 00 00 
    base.s.size = 0;
 648:	c7 05 50 09 00 00 00 	movl   $0x0,0x950
 64f:	00 00 00 
 652:	bf 4c 09 00 00       	mov    $0x94c,%edi
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
