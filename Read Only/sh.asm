...
fork1(void)
{
  ...
  bb:	68 95 10 00 00       	push   $0x1095
  c0:	6a 02                	push   $0x2
  c2:	e8 19 0c 00 00       	call   ce0 <printf>
...
000000fc <getcmd>:
{
 ...
 10a:	68 ec 0f 00 00       	push   $0xfec
 10f:	6a 02                	push   $0x2
 111:	e8 ca 0b 00 00       	call   ce0 <printf>
  memset(buf, 0, nbuf);
...
00000140 <panic>:
{
 ...
 149:	68 89 10 00 00       	push   $0x1089
 14e:	6a 02                	push   $0x2
 150:	e8 8b 0b 00 00       	call   ce0 <printf>
  exit();
...
0000015c <runcmd>:
{
 ...
 175:	ff 24 85 a4 10 00 00 	jmp    *0x10a4(,%eax,4)
    if(pipe(p) < 0)
 ...
 212:	68 f6 0f 00 00       	push   $0xff6
 217:	6a 02                	push   $0x2
 219:	e8 c2 0a 00 00       	call   ce0 <printf>
    break;
 ...
 272:	68 ef 0f 00 00       	push   $0xfef
 277:	e8 c4 fe ff ff       	call   140 <panic>
      printf(2, "open %s failed\n", rcmd->file);
 27c:	51                   	push   %ecx
 27d:	ff 73 08             	pushl  0x8(%ebx)
 280:	68 06 10 00 00       	push   $0x1006
 285:	6a 02                	push   $0x2
 287:	e8 54 0a 00 00       	call   ce0 <printf>
      exit();
 28c:	e8 14 09 00 00       	call   ba5 <exit>
      panic("pipe");
 291:	83 ec 0c             	sub    $0xc,%esp
 294:	68 1b 10 00 00       	push   $0x101b
 ...
 2fd:	68 16 10 00 00       	push   $0x1016
...
00000308 <fork1>:
{
 ...
 31d:	68 16 10 00 00       	push   $0x1016
...
execcmd(void)
{
 ...
 32f:	6a 54                	push   $0x54
 331:	e8 be 0b 00 00       	call   ef4 <malloc>
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
 ...
 358:	83 ec 10             	sub    $0x10,%esp
  ...
  cmd = malloc(sizeof(*cmd));
 35b:	6a 18                	push   $0x18
 35d:	e8 92 0b 00 00       	call   ef4 <malloc>
...
pipecmd(struct cmd *left, struct cmd *right)
{
 ...
 3a0:	83 ec 10             	sub    $0x10,%esp
  ...
  cmd = malloc(sizeof(*cmd));
 3a3:	6a 0c                	push   $0xc
 3a5:	e8 4a 0b 00 00       	call   ef4 <malloc>
...
listcmd(struct cmd *left, struct cmd *right)
{
 ...
 3d8:	83 ec 10             	sub    $0x10,%esp
  ...
  cmd = malloc(sizeof(*cmd));
 3db:	6a 0c                	push   $0xc
 3dd:	e8 12 0b 00 00       	call   ef4 <malloc>
...
backcmd(struct cmd *subcmd)
{
 ...
 410:	83 ec 10             	sub    $0x10,%esp
  ...
  cmd = malloc(sizeof(*cmd));
 413:	6a 08                	push   $0x8
 415:	e8 da 0a 00 00       	call   ef4 <malloc>
...
gettoken(char **ps, char *es, char **q, char **eq)
{
 ...
 463:	50                   	push   %eax
 464:	68 a4 16 00 00       	push   $0x16a4
 ...
 4b3:	50                   	push   %eax
 4b4:	68 a4 16 00 00       	push   $0x16a4
 ...
 4ee:	50                   	push   %eax
 4ef:	68 9c 16 00 00       	push   $0x169c
 ...
 50b:	50                   	push   %eax
 50c:	68 a4 16 00 00       	push   $0x16a4
...
peek(char **ps, char *es, char *toks)
{
 ...
 597:	50                   	push   %eax
 598:	68 a4 16 00 00       	push   $0x16a4
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
 ...
 5eb:	90                   	nop
 5ec:	50                   	push   %eax
 5ed:	68 3d 10 00 00       	push   $0x103d
 5f2:	53                   	push   %ebx
 5f3:	56                   	push   %esi
 ...
 66e:	68 20 10 00 00       	push   $0x1020
...
parseexec(char **ps, char *es)
{
 ...
 684:	8b 7d 0c             	mov    0xc(%ebp),%edi
  ...
  if(peek(ps, es, "("))
 687:	68 40 10 00 00       	push   $0x1040
 68c:	57                   	push   %edi
 68d:	56                   	push   %esi
 ...
 6ca:	83 c4 10             	add    $0x10,%esp
  while(!peek(ps, es, "|)&;")){
 6cd:	50                   	push   %eax
 6ce:	68 57 10 00 00       	push   $0x1057
 6d3:	57                   	push   %edi
 6d4:	56                   	push   %esi
 ...
 716:	68 49 10 00 00       	push   $0x1049
 ...
 75e:	68 42 10 00 00       	push   $0x1042
...
00000768 <parsepipe>:
{
 ...
 783:	68 5c 10 00 00       	push   $0x105c
 788:	57                   	push   %edi
 789:	56                   	push   %esi
...
000007cc <parseline>:
{
 ...
 801:	83 c4 10             	add    $0x10,%esp
  while(peek(ps, es, "&")){
 804:	50                   	push   %eax
 805:	68 5e 10 00 00       	push   $0x105e
 80a:	57                   	push   %edi
 80b:	56                   	push   %esi
 ...
 816:	75 d4                	jne    7ec <parseline+0x20>
  if(peek(ps, es, ";")){
 818:	51                   	push   %ecx
 819:	68 5a 10 00 00       	push   $0x105a
 81e:	57                   	push   %edi
 81f:	56                   	push   %esi
...
00000864 <parseblock>:
{
 ...
 870:	8b 75 0c             	mov    0xc(%ebp),%esi
  if(!peek(ps, es, "("))
 873:	68 40 10 00 00       	push   $0x1040
 878:	56                   	push   %esi
 879:	53                   	push   %ebx
 ...
 89f:	68 7c 10 00 00       	push   $0x107c
 8a4:	56                   	push   %esi
 8a5:	53                   	push   %ebx
...
nulterminate(struct cmd *cmd)
{
 ...
 903:	ff 24 85 bc 10 00 00 	jmp    *0x10bc(,%eax,4)
...
00000988 <parsecmd>:
{
 ...
 9ac:	68 05 10 00 00       	push   $0x1005
 9b1:	53                   	push   %ebx
 ...
 9d7:	52                   	push   %edx
 9d8:	50                   	push   %eax
 9d9:	68 7e 10 00 00       	push   $0x107e
 9de:	6a 02                	push   $0x2
 9e0:	e8 fb 02 00 00       	call   ce0 <printf>
    panic("syntax");
 9e5:	c7 04 24 42 10 00 00 	movl   $0x1042,(%esp)
...
00000c4d <munprotect>:
SYSCALL(munprotect)
 c4d:	b8 17 00 00 00       	mov    $0x17,%eax
 c52:	cd 40                	int    $0x40
 c54:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 c5c:	56                   	push   %esi
 c5d:	53                   	push   %ebx
 c5e:	83 ec 3c             	sub    $0x3c,%esp
 c61:	89 45 bc             	mov    %eax,-0x44(%ebp)
 c64:	89 4d c4             	mov    %ecx,-0x3c(%ebp)
  uint x;
  ...
  if(sgn && xx < 0){
    neg = 1;
    x = -xx;
 c67:	89 d1                	mov    %edx,%ecx
  if(sgn && xx < 0){
 c69:	8b 5d 08             	mov    0x8(%ebp),%ebx
 c6c:	85 db                	test   %ebx,%ebx
 c6e:	74 04                	je     c74 <printint+0x1c>
 c70:	85 d2                	test   %edx,%edx
 c72:	78 68                	js     cdc <printint+0x84>
  neg = 0;
 c74:	c7 45 08 00 00 00 00 	movl   $0x0,0x8(%ebp)
  } else {
    x = xx;
  }
 ...
 c7d:	8d 75 d7             	lea    -0x29(%ebp),%esi
  do{
    buf[i++] = digits[x % base];
 c80:	89 c8                	mov    %ecx,%eax
 c82:	31 d2                	xor    %edx,%edx
 c84:	f7 75 c4             	divl   -0x3c(%ebp)
 c87:	89 fb                	mov    %edi,%ebx
 c89:	8d 7f 01             	lea    0x1(%edi),%edi
 c8c:	8a 92 dc 10 00 00    	mov    0x10dc(%edx),%dl
 c92:	88 54 1e 01          	mov    %dl,0x1(%esi,%ebx,1)
  }while((x /= base) != 0);
 c96:	89 4d c0             	mov    %ecx,-0x40(%ebp)
 c99:	89 c1                	mov    %eax,%ecx
 c9b:	8b 45 c4             	mov    -0x3c(%ebp),%eax
 c9e:	3b 45 c0             	cmp    -0x40(%ebp),%eax
 ca1:	76 dd                	jbe    c80 <printint+0x28>
  if(neg)
 ca3:	8b 4d 08             	mov    0x8(%ebp),%ecx
 ca6:	85 c9                	test   %ecx,%ecx
 ca8:	74 09                	je     cb3 <printint+0x5b>
    buf[i++] = '-';
 caa:	c6 44 3d d8 2d       	movb   $0x2d,-0x28(%ebp,%edi,1)
    buf[i++] = digits[x % base];
 caf:	89 fb                	mov    %edi,%ebx
    buf[i++] = '-';
 cb1:	b2 2d                	mov    $0x2d,%dl

  while(--i >= 0)
 cb3:	8d 5c 1d d7          	lea    -0x29(%ebp,%ebx,1),%ebx
 cb7:	8b 7d bc             	mov    -0x44(%ebp),%edi
 cba:	eb 03                	jmp    cbf <printint+0x67>
 cbc:	8a 13                	mov    (%ebx),%dl
 cbe:	4b                   	dec    %ebx
    putc(fd, buf[i]);
 cbf:	88 55 d7             	mov    %dl,-0x29(%ebp)
  write(fd, &c, 1);
 cc2:	50                   	push   %eax
 cc3:	6a 01                	push   $0x1
 cc5:	56                   	push   %esi
 cc6:	57                   	push   %edi
 cc7:	e8 f9 fe ff ff       	call   bc5 <write>
  while(--i >= 0)
 ccc:	83 c4 10             	add    $0x10,%esp
 ccf:	39 de                	cmp    %ebx,%esi
 cd1:	75 e9                	jne    cbc <printint+0x64>
}
 ...
 cdb:	90                   	nop
    x = -xx;
 cdc:	f7 d9                	neg    %ecx
 cde:	eb 9b                	jmp    c7b <printint+0x23>
...
printf(int fd, const char *fmt, ...)
{
 ...
 cf0:	0f 84 a3 00 00 00    	je     d99 <printf+0xb9>
 cf6:	46                   	inc    %esi
  ap = (uint*)(void*)&fmt + 1;
 cf7:	8d 45 10             	lea    0x10(%ebp),%eax
 cfa:	89 45 d0             	mov    %eax,-0x30(%ebp)
  state = 0;
 cfd:	31 d2                	xor    %edx,%edx
  write(fd, &c, 1);
 cff:	8d 7d e7             	lea    -0x19(%ebp),%edi
 d02:	eb 29                	jmp    d2d <printf+0x4d>
 d04:	89 55 d4             	mov    %edx,-0x2c(%ebp)
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
 d07:	83 f8 25             	cmp    $0x25,%eax
 d0a:	0f 84 94 00 00 00    	je     da4 <printf+0xc4>
        state = '%';
      } else {
        putc(fd, c);
 d10:	88 5d e7             	mov    %bl,-0x19(%ebp)
  write(fd, &c, 1);
 d13:	50                   	push   %eax
 d14:	6a 01                	push   $0x1
 d16:	57                   	push   %edi
 d17:	ff 75 08             	pushl  0x8(%ebp)
 d1a:	e8 a6 fe ff ff       	call   bc5 <write>
        putc(fd, c);
 d1f:	83 c4 10             	add    $0x10,%esp
 d22:	8b 55 d4             	mov    -0x2c(%ebp),%edx
  for(i = 0; fmt[i]; i++){
 d25:	46                   	inc    %esi
 d26:	8a 5e ff             	mov    -0x1(%esi),%bl
 d29:	84 db                	test   %bl,%bl
 d2b:	74 6c                	je     d99 <printf+0xb9>
    c = fmt[i] & 0xff;
 d2d:	0f be cb             	movsbl %bl,%ecx
 d30:	0f b6 c3             	movzbl %bl,%eax
    if(state == 0){
 d33:	85 d2                	test   %edx,%edx
 d35:	74 cd                	je     d04 <printf+0x24>
      }
    } else if(state == '%'){
 d37:	83 fa 25             	cmp    $0x25,%edx
 d3a:	75 e9                	jne    d25 <printf+0x45>
      if(c == 'd'){
 d3c:	83 f8 64             	cmp    $0x64,%eax
 d3f:	0f 84 97 00 00 00    	je     ddc <printf+0xfc>
        printint(fd, *ap, 10, 1);
        ap++;
      } else if(c == 'x' || c == 'p'){
 d45:	81 e1 f7 00 00 00    	and    $0xf7,%ecx
 d4b:	83 f9 70             	cmp    $0x70,%ecx
 d4e:	74 60                	je     db0 <printf+0xd0>
        printint(fd, *ap, 16, 0);
        ap++;
      } else if(c == 's'){
 d50:	83 f8 73             	cmp    $0x73,%eax
 d53:	0f 84 8f 00 00 00    	je     de8 <printf+0x108>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
 ...
 d59:	83 f8 63             	cmp    $0x63,%eax
 d5c:	0f 84 d6 00 00 00    	je     e38 <printf+0x158>
        putc(fd, *ap);
        ap++;
      } else if(c == '%'){
 d62:	83 f8 25             	cmp    $0x25,%eax
 d65:	0f 84 c1 00 00 00    	je     e2c <printf+0x14c>
        putc(fd, c);
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
 d6b:	c6 45 e7 25          	movb   $0x25,-0x19(%ebp)
  write(fd, &c, 1);
 d6f:	50                   	push   %eax
 d70:	6a 01                	push   $0x1
 d72:	57                   	push   %edi
 d73:	ff 75 08             	pushl  0x8(%ebp)
 d76:	e8 4a fe ff ff       	call   bc5 <write>
        putc(fd, c);
 d7b:	88 5d e7             	mov    %bl,-0x19(%ebp)
  write(fd, &c, 1);
 d7e:	83 c4 0c             	add    $0xc,%esp
 d81:	6a 01                	push   $0x1
 d83:	57                   	push   %edi
 d84:	ff 75 08             	pushl  0x8(%ebp)
 d87:	e8 39 fe ff ff       	call   bc5 <write>
        putc(fd, c);
 d8c:	83 c4 10             	add    $0x10,%esp
      }
      state = 0;
 d8f:	31 d2                	xor    %edx,%edx
  for(i = 0; fmt[i]; i++){
 d91:	46                   	inc    %esi
 d92:	8a 5e ff             	mov    -0x1(%esi),%bl
 d95:	84 db                	test   %bl,%bl
 d97:	75 94                	jne    d2d <printf+0x4d>
    }
  }
}
 ...
 d9f:	5d                   	pop    %ebp
 da0:	c3                   	ret    
 da1:	8d 76 00             	lea    0x0(%esi),%esi
        state = '%';
 da4:	ba 25 00 00 00       	mov    $0x25,%edx
 da9:	e9 77 ff ff ff       	jmp    d25 <printf+0x45>
 dae:	66 90                	xchg   %ax,%ax
        printint(fd, *ap, 16, 0);
 db0:	83 ec 0c             	sub    $0xc,%esp
 db3:	6a 00                	push   $0x0
 db5:	b9 10 00 00 00       	mov    $0x10,%ecx
 dba:	8b 5d d0             	mov    -0x30(%ebp),%ebx
 dbd:	8b 13                	mov    (%ebx),%edx
 dbf:	8b 45 08             	mov    0x8(%ebp),%eax
 dc2:	e8 91 fe ff ff       	call   c58 <printint>
        ap++;
 dc7:	89 d8                	mov    %ebx,%eax
 dc9:	83 c0 04             	add    $0x4,%eax
 dcc:	89 45 d0             	mov    %eax,-0x30(%ebp)
 dcf:	83 c4 10             	add    $0x10,%esp
      state = 0;
 dd2:	31 d2                	xor    %edx,%edx
        ap++;
 dd4:	e9 4c ff ff ff       	jmp    d25 <printf+0x45>
 dd9:	8d 76 00             	lea    0x0(%esi),%esi
        printint(fd, *ap, 10, 1);
 ddc:	83 ec 0c             	sub    $0xc,%esp
 ddf:	6a 01                	push   $0x1
 de1:	b9 0a 00 00 00       	mov    $0xa,%ecx
 de6:	eb d2                	jmp    dba <printf+0xda>
        s = (char*)*ap;
 de8:	8b 45 d0             	mov    -0x30(%ebp),%eax
 deb:	8b 18                	mov    (%eax),%ebx
        ap++;
 ded:	83 c0 04             	add    $0x4,%eax
 df0:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
 df3:	85 db                	test   %ebx,%ebx
 df5:	74 65                	je     e5c <printf+0x17c>
        while(*s != 0){
 df7:	8a 03                	mov    (%ebx),%al
 df9:	84 c0                	test   %al,%al
 dfb:	74 70                	je     e6d <printf+0x18d>
 dfd:	89 75 d4             	mov    %esi,-0x2c(%ebp)
 e00:	89 de                	mov    %ebx,%esi
 e02:	8b 5d 08             	mov    0x8(%ebp),%ebx
 ...
 e0e:	57                   	push   %edi
 e0f:	53                   	push   %ebx
 e10:	e8 b0 fd ff ff       	call   bc5 <write>
          s++;
 e15:	46                   	inc    %esi
        while(*s != 0){
 e16:	8a 06                	mov    (%esi),%al
 e18:	83 c4 10             	add    $0x10,%esp
 e1b:	84 c0                	test   %al,%al
 e1d:	75 e9                	jne    e08 <printf+0x128>
 e1f:	8b 75 d4             	mov    -0x2c(%ebp),%esi
      state = 0;
 e22:	31 d2                	xor    %edx,%edx
 e24:	e9 fc fe ff ff       	jmp    d25 <printf+0x45>
 e29:	8d 76 00             	lea    0x0(%esi),%esi
        putc(fd, c);
 e2c:	88 5d e7             	mov    %bl,-0x19(%ebp)
  write(fd, &c, 1);
 e2f:	52                   	push   %edx
 e30:	e9 4c ff ff ff       	jmp    d81 <printf+0xa1>
 e35:	8d 76 00             	lea    0x0(%esi),%esi
        putc(fd, *ap);
 e38:	8b 5d d0             	mov    -0x30(%ebp),%ebx
 e3b:	8b 03                	mov    (%ebx),%eax
 e3d:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 e40:	51                   	push   %ecx
 e41:	6a 01                	push   $0x1
 e43:	57                   	push   %edi
 e44:	ff 75 08             	pushl  0x8(%ebp)
 e47:	e8 79 fd ff ff       	call   bc5 <write>
        ap++;
 e4c:	83 c3 04             	add    $0x4,%ebx
 e4f:	89 5d d0             	mov    %ebx,-0x30(%ebp)
 e52:	83 c4 10             	add    $0x10,%esp
      state = 0;
 e55:	31 d2                	xor    %edx,%edx
 e57:	e9 c9 fe ff ff       	jmp    d25 <printf+0x45>
          s = "(null)";
 e5c:	bb d4 10 00 00       	mov    $0x10d4,%ebx
        while(*s != 0){
 e61:	b0 28                	mov    $0x28,%al
 e63:	89 75 d4             	mov    %esi,-0x2c(%ebp)
 e66:	89 de                	mov    %ebx,%esi
 e68:	8b 5d 08             	mov    0x8(%ebp),%ebx
 e6b:	eb 9b                	jmp    e08 <printf+0x128>
      state = 0;
 e6d:	31 d2                	xor    %edx,%edx
 e6f:	e9 b1 fe ff ff       	jmp    d25 <printf+0x45>
...
free(void *ap)
{
 ...
 e78:	56                   	push   %esi
 e79:	53                   	push   %ebx
 e7a:	8b 5d 08             	mov    0x8(%ebp),%ebx
  Header *bp, *p;

  bp = (Header*)ap - 1;
 e7d:	8d 4b f8             	lea    -0x8(%ebx),%ecx
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
 e80:	a1 24 17 00 00       	mov    0x1724,%eax
 e85:	8b 10                	mov    (%eax),%edx
 e87:	39 c8                	cmp    %ecx,%eax
 e89:	73 11                	jae    e9c <free+0x28>
 e8b:	90                   	nop
 e8c:	39 d1                	cmp    %edx,%ecx
 e8e:	72 14                	jb     ea4 <free+0x30>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
 e90:	39 d0                	cmp    %edx,%eax
 e92:	73 10                	jae    ea4 <free+0x30>
{
 e94:	89 d0                	mov    %edx,%eax
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
 e96:	8b 10                	mov    (%eax),%edx
 e98:	39 c8                	cmp    %ecx,%eax
 e9a:	72 f0                	jb     e8c <free+0x18>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
 e9c:	39 d0                	cmp    %edx,%eax
 e9e:	72 f4                	jb     e94 <free+0x20>
 ea0:	39 d1                	cmp    %edx,%ecx
 ea2:	73 f0                	jae    e94 <free+0x20>
      break;
  if(bp + bp->s.size == p->s.ptr){
 ea4:	8b 73 fc             	mov    -0x4(%ebx),%esi
 ea7:	8d 3c f1             	lea    (%ecx,%esi,8),%edi
 eaa:	39 fa                	cmp    %edi,%edx
 eac:	74 1a                	je     ec8 <free+0x54>
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
 eae:	89 53 f8             	mov    %edx,-0x8(%ebx)
  if(p + p->s.size == bp){
 eb1:	8b 50 04             	mov    0x4(%eax),%edx
 eb4:	8d 34 d0             	lea    (%eax,%edx,8),%esi
 eb7:	39 f1                	cmp    %esi,%ecx
 eb9:	74 24                	je     edf <free+0x6b>
    p->s.size += bp->s.size;
    p->s.ptr = bp->s.ptr;
  } else
    p->s.ptr = bp;
 ebb:	89 08                	mov    %ecx,(%eax)
  freep = p;
 ebd:	a3 24 17 00 00       	mov    %eax,0x1724
}
 ec2:	5b                   	pop    %ebx
 ec3:	5e                   	pop    %esi
 ec4:	5f                   	pop    %edi
 ...
 ec7:	90                   	nop
    bp->s.size += p->s.ptr->s.size;
 ec8:	03 72 04             	add    0x4(%edx),%esi
 ecb:	89 73 fc             	mov    %esi,-0x4(%ebx)
    bp->s.ptr = p->s.ptr->s.ptr;
 ece:	8b 10                	mov    (%eax),%edx
 ed0:	8b 12                	mov    (%edx),%edx
 ed2:	89 53 f8             	mov    %edx,-0x8(%ebx)
  if(p + p->s.size == bp){
 ed5:	8b 50 04             	mov    0x4(%eax),%edx
 ed8:	8d 34 d0             	lea    (%eax,%edx,8),%esi
 edb:	39 f1                	cmp    %esi,%ecx
 edd:	75 dc                	jne    ebb <free+0x47>
    p->s.size += bp->s.size;
 edf:	03 53 fc             	add    -0x4(%ebx),%edx
 ee2:	89 50 04             	mov    %edx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
 ee5:	8b 53 f8             	mov    -0x8(%ebx),%edx
 ee8:	89 10                	mov    %edx,(%eax)
  freep = p;
 eea:	a3 24 17 00 00       	mov    %eax,0x1724
}
 eef:	5b                   	pop    %ebx
 ef0:	5e                   	pop    %esi
 ef1:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 ef8:	56                   	push   %esi
 ef9:	53                   	push   %ebx
 efa:	83 ec 1c             	sub    $0x1c,%esp
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 efd:	8b 45 08             	mov    0x8(%ebp),%eax
 f00:	8d 70 07             	lea    0x7(%eax),%esi
 f03:	c1 ee 03             	shr    $0x3,%esi
 f06:	46                   	inc    %esi
  if((prevp = freep) == 0){
 f07:	8b 3d 24 17 00 00    	mov    0x1724,%edi
 f0d:	85 ff                	test   %edi,%edi
 f0f:	0f 84 a3 00 00 00    	je     fb8 <malloc+0xc4>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 f15:	8b 07                	mov    (%edi),%eax
    if(p->s.size >= nunits){
 f17:	8b 48 04             	mov    0x4(%eax),%ecx
 f1a:	39 f1                	cmp    %esi,%ecx
 f1c:	73 67                	jae    f85 <malloc+0x91>
 f1e:	89 f3                	mov    %esi,%ebx
 f20:	81 fe 00 10 00 00    	cmp    $0x1000,%esi
 f26:	0f 82 80 00 00 00    	jb     fac <malloc+0xb8>
  p = sbrk(nu * sizeof(Header));
 f2c:	8d 0c dd 00 00 00 00 	lea    0x0(,%ebx,8),%ecx
 f33:	89 4d e4             	mov    %ecx,-0x1c(%ebp)
 f36:	eb 11                	jmp    f49 <malloc+0x55>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 f38:	8b 10                	mov    (%eax),%edx
    if(p->s.size >= nunits){
 f3a:	8b 4a 04             	mov    0x4(%edx),%ecx
 f3d:	39 f1                	cmp    %esi,%ecx
 f3f:	73 4b                	jae    f8c <malloc+0x98>
 f41:	8b 3d 24 17 00 00    	mov    0x1724,%edi
 f47:	89 d0                	mov    %edx,%eax
    ...
    if(p == freep)
 f49:	39 c7                	cmp    %eax,%edi
 f4b:	75 eb                	jne    f38 <malloc+0x44>
  p = sbrk(nu * sizeof(Header));
 f4d:	83 ec 0c             	sub    $0xc,%esp
 f50:	ff 75 e4             	pushl  -0x1c(%ebp)
 f53:	e8 d5 fc ff ff       	call   c2d <sbrk>
  if(p == (char*)-1)
 f58:	83 c4 10             	add    $0x10,%esp
 f5b:	83 f8 ff             	cmp    $0xffffffff,%eax
 f5e:	74 1b                	je     f7b <malloc+0x87>
  hp->s.size = nu;
 ...
 f69:	50                   	push   %eax
 f6a:	e8 05 ff ff ff       	call   e74 <free>
  return freep;
 f6f:	a1 24 17 00 00       	mov    0x1724,%eax
      if((p = morecore(nunits)) == 0)
 f74:	83 c4 10             	add    $0x10,%esp
 f77:	85 c0                	test   %eax,%eax
 f79:	75 bd                	jne    f38 <malloc+0x44>
        return 0;
 f7b:	31 c0                	xor    %eax,%eax
  }
}
 f7d:	8d 65 f4             	lea    -0xc(%ebp),%esp
 f80:	5b                   	pop    %ebx
 f81:	5e                   	pop    %esi
 f82:	5f                   	pop    %edi
 f83:	5d                   	pop    %ebp
 f84:	c3                   	ret    
    if(p->s.size >= nunits){
 f85:	89 c2                	mov    %eax,%edx
 f87:	89 f8                	mov    %edi,%eax
 f89:	8d 76 00             	lea    0x0(%esi),%esi
      if(p->s.size == nunits)
 f8c:	39 ce                	cmp    %ecx,%esi
 f8e:	74 54                	je     fe4 <malloc+0xf0>
        p->s.size -= nunits;
 f90:	29 f1                	sub    %esi,%ecx
 f92:	89 4a 04             	mov    %ecx,0x4(%edx)
        p += p->s.size;
 f95:	8d 14 ca             	lea    (%edx,%ecx,8),%edx
        p->s.size = nunits;
 f98:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 f9b:	a3 24 17 00 00       	mov    %eax,0x1724
      return (void*)(p + 1);
 fa0:	8d 42 08             	lea    0x8(%edx),%eax
}
 ...
 faa:	c3                   	ret    
 fab:	90                   	nop
 fac:	bb 00 10 00 00       	mov    $0x1000,%ebx
 fb1:	e9 76 ff ff ff       	jmp    f2c <malloc+0x38>
 fb6:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 fb8:	c7 05 24 17 00 00 28 	movl   $0x1728,0x1724
 fbf:	17 00 00 
 fc2:	c7 05 28 17 00 00 28 	movl   $0x1728,0x1728
 fc9:	17 00 00 
    base.s.size = 0;
 fcc:	c7 05 2c 17 00 00 00 	movl   $0x0,0x172c
 fd3:	00 00 00 
 fd6:	bf 28 17 00 00       	mov    $0x1728,%edi
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 fdb:	89 f8                	mov    %edi,%eax
 fdd:	e9 3c ff ff ff       	jmp    f1e <malloc+0x2a>
 fe2:	66 90                	xchg   %ax,%ax
        prevp->s.ptr = p->s.ptr;
 fe4:	8b 0a                	mov    (%edx),%ecx
 fe6:	89 08                	mov    %ecx,(%eax)
 fe8:	eb b1                	jmp    f9b <malloc+0xa7>
